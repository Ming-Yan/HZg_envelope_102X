...
def get_options():
  ...
  parser.add_option("--doBands", dest="doBands", default=True, action="store_true", help="Do +-1/2sigma bands for bkg model")
  parser.add_option("--doToyVeto", dest="doToyVeto", default=True, action="store_true", help="Veto non-sensical toys with 0 as first entry in bin")
  ...
  parser.add_option("--doSumCategories", dest="doSumCategories", default=True, action="store_true", help="Do plot summing the categories being processed")
  parser.add_option("--doCatWeights", dest="doCatWeights", default=True, action="store_true", help="Do S/S+B weighted plot")
  parser.add_option("--loadWeights", dest="loadWeights", default='', help="JSON file storing category weights")
  parser.add_option("--saveWeights", dest="saveWeights", default=True, action='store_true', help="Save category weights to json file")
