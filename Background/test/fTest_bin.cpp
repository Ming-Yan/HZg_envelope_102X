...
double getProbabilityFtest(double chi2, int ndof,RooAbsPdf *pdfNull, RooAbsPdf *pdfTest, RooRealVar *mass, RooDataHist *data, std::string name){
...
double getGoodnessOfFit(RooRealVar *mass, RooAbsPdf *mpdf, RooDataHist *data, std::string name){
...
void plot(RooRealVar *mass, RooAbsPdf *pdf, RooDataHist *data, string name,vector<string> flashggCats_, int status, double *prob){
...
void plot(RooRealVar *mass, RooMultiPdf *pdfs, RooCategory *catIndex, RooDataHist *data, string name, string type,vector<string> flashggCats_, int cat, int bestFitPdf=-1){
...
void plot(RooRealVar *mass, map<string,RooAbsPdf*> pdfs, RooDataHist *data, string name, string type, vector<string> flashggCats_, int cat, int bestFitPdf=-1){
...
int getBestFitFunction(RooMultiPdf *bkg, RooDataHist *data, RooCategory *cat, bool silent=false){
