...
RooAbsPdf* PdfModelBuilder::getLaurentStepxGau(string prefix, int order, int cat){
 ...
 if(cat==1)
  {
    if(order==1){
    turnon_lau = 108;      turnon_llau = 106.;   turnon_hlau = 110.;
  ...
  {
    if(order==1){
    turnon_lau = 108.32;      turnon_llau = 106.;   turnon_hlau = 109.;
    ...
    turnon_lau = 108.2;       turnon_llau = 107.;   turnon_hlau = 109.;
    ...
    {
    turnon_lau = 106.5;         turnon_llau = 104.;   turnon_hlau = 109.;
